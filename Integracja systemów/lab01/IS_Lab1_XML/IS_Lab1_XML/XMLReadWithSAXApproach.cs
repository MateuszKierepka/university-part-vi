...
internal class XMLReadWithSAXApproach
{
    internal static void Read(string xmlpath)
    {
        ...
        Console.WriteLine("Najwięcej tabletek produkuje: {0} ({1})", maxTabletki.Key, maxTabletki.Value);
        Console.WriteLine("Najwięcej kremów produkuje: {0} ({1})", maxKremy.Key, maxKremy.Value);
